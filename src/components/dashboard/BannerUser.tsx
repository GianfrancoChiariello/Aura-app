...
const BannerUser = () => {
  return (
    <div className="w-full h-full grid grid-cols-6 items-center px-2">
        <div className="col-span-6 xl:col-span-4 grid gap-2 justify-center px-2">
            <h3 className="font-semibold text-2xl text-center lg:text-left">Hi Gianfranco</h3>
            <p className="text-lg font-normal text-wrap hidden lg:block">Welcome to manager in your enviroment</p>
